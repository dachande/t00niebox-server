  ...
  <body class="hold-transition login-page">
    <div class="login-box">
      ...
      <div class="login-box-body">
        ...
        <?php if (isset($theme['login']['show_social']) && $theme['login']['show_social']): ?>
        ...
        <?php if (isset($theme['login']['show_remember']) && $theme['login']['show_remember']): ?>
          <a href="#"><?= __('I forgot my password') ?></a><br>
        <?php endif; ?>
        <?php if (isset($theme['login']['show_register']) && $theme['login']['show_register']): ?>
